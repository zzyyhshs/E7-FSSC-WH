...
search_input_xpath = "xpath->//input[@placeholder='请输入关键字']"
search_input_xpath2 = "xpath->//input[@placeholder='搜索']"
search_submit_xpath = "xpath->//input[@class='searchBtnSize']"
search_submit_xpath2 = "xpath->//input[@class='search-icon']"
search_submit_xpath3 = "xpath->//button[@class='button button-clear']"
...
select_sure4 = "xpath->//span[@class='treeModel-operate'][2]"
