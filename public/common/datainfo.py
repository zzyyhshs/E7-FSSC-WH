...
testDataPath = os.path.join(globalparam.data_path,"testdata")
# pagedata_path = os.path.join(globalparam.data_path,"pagedata")
test_path = globalparam.data_path
#fileName = globalparam.fileName
def get_xls_to_dict(fileName, sheetName):#文件名，sheet名，列名   输出：[{'列名行[0]':'第2行[0]','列名行[1]':'第2行[1]'....},{'列名行[0]':'第3行[0]','列名行[1]':'第3行[1]'}.....]
    ...
    for i in range(1,len(dataResult)):#len(dataresult)：数组的元素个数，
        temp = dict(zip(dataResult[0],dataResult[i]))#dict（zip(list1,list2)）--> [{list1[0]:list2[0]},{list1[1]:list2[1]}......]
...
def createFile(fileName,sheetnameList,datasList):
...
if __name__=='__main__':
    ...
    res = getAllUsers("bill.xlsx","users","name")
    # print(res)
    # res = getColumnToList('query.xlsx','ModularData',"TableValue")
    # print(res)
    # res = get_xls_to_dict('terminalType.xlsx','DictData',"TMS_DM_TerminalType_0001")[0]
    # print(res)
    # print(len(res))
    # print(res["casenumber"])
    #
    # print("-------------------------------------------------------------")
    #
    # res1 = get_xls_to_dict('terminalType.xlsx','DictData',"TMS_DM_TerminalType_0001")
    ...
    # print("---------------------------------------------------------------")
    #
    # res2 = get_xls_to_list('terminalType.xlsx','DictData',"TMS_DM_TerminalType_0001")[0]
    # print(res2)
    # print(len(res2))
    #
    # res3 = get_xls_to_list('terminalType.xlsx','DictData',"TMS_DM_TerminalType_0001")
    ...
    # print("--------------------------------------------------------------")
    #
    # res4 = getColumnToList('terminalType.xlsx','DictData',"casenumber")
    # print(res4)
    #
    # print("--------------------------------------------------------------")
    #
    # res5 = getColumnToDict('terminalType.xlsx','DictData',0,2)
    # print(res5)

    # print(res)
    # res = get_xls_to_dict("terminalType.xlsx",'DictData',"TMS_DM_TerminalType_0001")
    # print("aa")
    # for re in res:
    #     print(re)
    # print("aa")
    # testDataes = get_xls_to_list("terminalType.xlsx",'ListData',"TMS_DM_TerminalType_0001")
    # print("aa")
    # for testData in testDataes:
    #     testData.remove("TMS_DM_TerminalType_0001")
    #     print(testData)
