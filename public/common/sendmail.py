...
logger = Log()
# 配置收发件人
recvaddress = ['yiyinhua@szzt.com.cn', 'wangxiaoping@szzt.com.cn']
# 163的用户名和密码
sendaddr_name = 'cuichang@szzt.com.cn'
sendaddr_pswd = 'szzt@002197'
...
class SendMail:
    ...
    def send(self):
        ...
        try:
            smtp = smtplib.SMTP('mail.szzt.com.cn', 25)
