...
class test_B_FYSQD1(mytest.MyTest):
	"""测试单据-AutoTestGroup-B_费用申请单_01"""
	@unittest.skipUnless(globalparam.usecase_run_mode >= 1, "")
	def test_B_FYSQD1_01(self):
		"""测试单据-AutoTestGroup-B_费用申请单_01Auto模式"""
		#初始化测试对象
		fsscTest = SubmitToBillPage.SubmitToBillPage(self.dr)
		#准备测试数据
		# billGroup = "AutoTestGroup"
		billName = "B_费用申请单_01"
		fillPerson = "填单用户001"
		approvalModel = "Auto"
		testCaseFile = "AutoTestGroup\B_费用申请单_01.xls"
