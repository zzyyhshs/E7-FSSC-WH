...
if __name__ == '__main__':
    ...
    project = ""
    itemBillType = mobileDataInfo.getColumnToDict(itemDataFill, "itemBillType", "itemBillType", "areaName")
    # itemBillType = {itemBillType : areaName}
    itemDisplayType = mobileDataInfo.getColumnToDict(itemDataFill, "itemDisplayType", "value", "trueType")
    # itemDisplayType = {value : trueType}
    itemDataType = mobileDataInfo.getColumnToDict(itemDataFill, "itemDataType", "value", "trueType")
    dataHead = ["field", "itemName", "itemType", "itemId","itemVarName","css","inputValue","verifyValue"]
    dataFilePath = os.path.join(globalparam.data_mobile_path, itemDataFill)
    ...
    for i in range(1,table.nrows):
        ...
        try:
            ...
            print(itemBillType[table.row_values(i)[1]])
    ...
    mobileDataInfo.createFile(file_path, ["billData"], [allItemData])